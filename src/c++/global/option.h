...
public:
	...
	DEF_OPT_STRING(sampvar);	// Alternative phenotype file name
	...
	DEF_OPT_NUMBER(varresize);
	DEF_OPT_NUMBER(varwindow);
	DEF_OPT_NUMBER(sampresize);
...
// #endif
// 
// #if (TOOLSET_TYPE & FUNCTION_PHARAOH) || ((TOOLSET_TYPE & 0x100) == 0x100)
