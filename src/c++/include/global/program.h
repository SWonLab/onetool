...
#define VERSION_ONETOOL "2.0.0"
#define VERSION_PROMUL	"0.9.0"
#define VERSION_HSCGGI	"0.9.0"

/* Program type */
#define TOOLSET_TYPE	TOOLSET_ONETOOL
...
#elif TOOLSET_TYPE == TOOLSET_FARVATX
...
#elif TOOLSET_TYPE == TOOLSET_MFARVAT
...
#elif TOOLSET_TYPE == TOOLSET_QTEST
...
#	define TOOLSET_CITE		"Lee J et al., Gene-set association tests for next-generation sequencing data,\n" \
							"Bioinformatics (2016)."
#elif TOOLSET_TYPE == TOOLSET_MFQLS
...
#elif TOOLSET_TYPE == TOOLSET_PHARAOH
