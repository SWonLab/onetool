...
class FcorAnalysis
{
  public:
    ...
    FcorAnalysis(const analysis_option_type& fo, const RefMultiPedigree* mp, cerrorstream& err = sage_cerr);
   
    void  view_pairs_xml(ostream& xml_out);
  ...
  protected:
    ...
    const analysis_option_type& get_analysis_options() const { return my_options; }

    const analysis_option_type&     my_options;
