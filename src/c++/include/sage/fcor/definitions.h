...
{
  pairset           = BOTH; //SUBTYPES;
  class_weight      = PAIR_WISE; //WEIGHT_COUNT;
...
static analysis_option_type dummy_analysis_option;

inline const analysis_option_type& get_analysis_options()
{
  return dummy_analysis_option;
}
