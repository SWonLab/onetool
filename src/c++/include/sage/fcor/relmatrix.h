...
#include "sage/global/ldatamap.h"
#include "sage/global/trimatrix.h"
#include "sage/fcor/relcomp.h"
...
class RelationMatrix
{
  public:
    ...
    void             view_pairs(std::ostream& out, const RPED::RefMultiPedigree& mp) const;
    void      view_pairs_gender(std::ostream& out, const RPED::RefMultiPedigree& mp) const;
    void         view_pairs_xml(std::ostream& out, const RPED::RefMultiPedigree& mp) const;

  private:

    const RPED::RefMultiPedigree*                my_multiped;
    std::vector< TriangleMatrix<RelationType> >  my_relmatrix;
...
#include "sage/fcor/relmatrix.ipp"
