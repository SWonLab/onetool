...
public:
  ...
  class const_iterator //: public std::iterator<std::bidirectional_iterator_tag, T, difference_type, pointer, const_reference>
  {
    public:
      ...
      const_iterator();
#ifdef _WIN32
	  const_iterator(const typename self_type::iterator& x);

	  bool                    operator==(const typename self_type::iterator& x) const;
	  bool                    operator!=(const typename self_type::iterator& x) const;

	  const_iterator&         operator=(const typename self_type::iterator& x);
#else
...
inline
#ifdef _WIN32
LinearDatamap<K, T, TypeCompare, Container>::const_iterator::const_iterator(const typename self_type::iterator& x)
#else
...
bool
#ifdef _WIN32
LinearDatamap<K, T, TypeCompare, Container>::const_iterator::operator==(const typename self_type::iterator& x) const
#else
...
#ifdef _WIN32
LinearDatamap<K, T, TypeCompare, Container>::const_iterator::operator=(const typename self_type::iterator& x)
#else
...
{
  std::pair<type_iterator, type_iterator>  t = my_multiplexer.equal_range(k);
...
{
  std::pair<type_const_iterator, type_const_iterator>  t = my_multiplexer.equal_range(k);
