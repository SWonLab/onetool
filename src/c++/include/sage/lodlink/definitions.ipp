...
{
  cout << "trait " << tg.name() << "  " << tg.is_male_compatible() << "," << tg.is_female_compatible() << "," << tg.frequency()
       << "marker " << mg.name() << "  " << mg.is_male_compatible() << "," << mg.is_female_compatible() << "," << mg.frequency() << endl;
}
