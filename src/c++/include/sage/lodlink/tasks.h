...
#include "sage/lodlink/results.h"
...
typedef std::shared_ptr<task_result>  result_ptr;
typedef std::shared_ptr<non_ss_alt_result>  non_ss_alt_result_ptr;
typedef std::shared_ptr<ss_alt_result>  ss_alt_result_ptr;
...
#include "sage/lodlink/tasks.ipp"
}
}
