...
#include "sage/maxfun/maxfundefs.h"
...
class Maxfun_Data
{
  ...
  public:
    ...
    struct maxf1_struct
    {
       MEM_FRIEND(Maxfun_Data::maxf1_struct);
    ...
    struct maxf2_struct
    {
       MEM_FRIEND(Maxfun_Data::maxf2_struct);
    ...
    {
      MEM_FRIEND(Maxfun_Data::maxflb_struct);
...
MEM_COUNT_BEGIN(MAXFUN::Maxfun_Data::maxf1_struct)
{
  return get_mem(t.thin) + get_mem(t.thl) + get_mem(t.thu) + get_mem(t.stpin) + get_mem(t.istin) + sizeof(t);
}
MEM_COUNT_END

MEM_COUNT_BEGIN(MAXFUN::Maxfun_Data::maxf2_struct)
{
...
MEM_COUNT_BEGIN(MAXFUN::Maxfun_Data::maxflb_struct)
{
...
MEM_COUNT_BEGIN(MAXFUN::Maxfun_Data)
{
