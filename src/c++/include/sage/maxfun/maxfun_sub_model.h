#ifndef MAXFUN_SUB_MODEL_H
#define MAXFUN_SUB_MODEL_H
//============================================================================
// File:      maxfun_sub_model.h
//                                                                          
...
struct model_input
{
  model_input(double i = SAGE::QNAN, bool f = false);
...
#include "sage/maxfun/maxfun_sub_model.ipp"
