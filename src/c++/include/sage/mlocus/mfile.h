...
public:
  ...
  virtual bool  input(inheritance_model_map& m, const string &filename, ostream &messages);
  virtual bool  input(inheritance_model_map& m, const string &filename, char separator, string a_miss, ostream &messages);
  ...
  void   set_marker_verbose_output(size_t v = (size_t)-1) { my_marker_verbose_output = (uint)v; }
  void   set_genotype_verbose_output(size_t v = (size_t)-1) { my_genotype_verbose_output = (uint)v; }
...
protected:
  ...
  void get_alleles   (istream&, genotype_model&);
