...
#include "sage/global/corinfo.h"
#include "sage/rped/rped.h"

typedef SAGE::RPED::pedigree_type        RefPedigree;
typedef SAGE::RPED::subpedigree_type     RefSubpedigree;
typedef SAGE::RPED::RefMultiPedigree     RefMultiPedigree;
typedef SAGE::RPED::member_const_pointer member_const_pointer;
typedef SAGE::RPED::RefMPedInfo          RefMPedInfo;
typedef SAGE::RPED::RefPedInfo           RefPedInfo;
typedef SAGE::RPED::RefTraitInfo         RefTraitInfo;
...
class pair_generator
{
  public:
    ...
    static string        pair_type_to_string(pair_type type);
    ...
    pair_generator(RefPedigree* p, unsigned int types = ALL_TYPES);
    ...
    // sets
    void             set_pedigree(RefPedigree* pedigree);
  ...
  public:                                 
    ...
    class relative_pair
    {
      ...
      public:
        typedef RefPedigree::member_pointer member;
      ...
      protected:
        ...
        // Constructor/destructor
         ...
         base_iterator(pair_generator* generator,
                       RefPedigree::family_iterator family);
        ...
        // Functions used in the implementation of operator ++().         
         ...
         void         init_halfsibs();
         bool         other_parent(RefPedigree::member_pointer mate);
         void               halfsib();
        ...
        // Data members.
        //
        std::unique_ptr<pair_generator>        my_generator;
        relative_pair                        my_pair;             // temporary pair
        
        // iterators
        RefPedigree::family_iterator         my_family;
        RefPedigree::offspring_iterator      my_children;
        RefPedigree::offspring_iterator      my_fullsibs;  
        RefPedigree::offspring_iterator      my_cousins;
        RefPedigree::offspring_iterator      my_halfsibs;
        RefPedigree::mate_iterator           my_parents_mates;
        RefPedigree::mate_iterator           my_avuncs_mates;
        RefPedigree::sibling_iterator        my_avuncs;
        
        // For pair_type, EVERY.
        RefMultiPedigree::subpedigree_iterator    my_subped;
        RefMultiPedigree::member_iterator         my_member_one;
        RefMultiPedigree::member_iterator         my_member_two;
        
        // member pointers
        RefPedigree::member_pointer          my_parent;
        RefPedigree::member_pointer          my_grandp;
...
class ind_filter_trait
{
  public:
    ...
    //
    bool              informative (const RefPedigree::member_pointer member)  const;
    bool              in_range    (const RefPedigree::member_pointer member)  const;
    bool              affected    (const RefPedigree::member_pointer member)  const;
    bool              unaffected  (const RefPedigree::member_pointer member)  const;
...
class filtering_pair_generator_rep
{
  typedef std::shared_ptr<filtering_pair_generator_rep> rep_ptr_type;
  ...
  public:
    ...
    class cache
    {
      public:
        ...
        cache_status     check_status(RefPedigree::member_pointer member);
        void             cache_add(RefPedigree::member_pointer member, cache_status status);        
...
#include "sage/pedinfo/relpair.ipp"
