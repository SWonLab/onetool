...
class Base_trait_stats
{
  public:
    ...
    /// Gender enum
    enum  gender { MALE = 0,   //Code for male
                   FEMALE,     //Code for female
                   UNKNOWN,    //Code for unknown sex
                   ALL };

    /// Founder status enum    
    enum  founder_status   { FOUNDER = 0,   //Code for founder
...
class Binary_trait_stats : public Base_trait_stats
{
  public:
    ...
    enum ind_affection_status { AFF = 0,  //Code for affected
...
#include "sage/pedinfo/stats.ipp"
