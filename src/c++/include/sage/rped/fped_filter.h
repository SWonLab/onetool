...
/// \internal
///
/// The FilterResults object uses a std::shared_ptr to contain each of the
...
class FilterResults
{
  ...
  private:
    ...
    typedef std::shared_ptr<MemberPtrList> MemberPtrListShPtr;
...
#include "sage/rped/fped_filter.ipp"
