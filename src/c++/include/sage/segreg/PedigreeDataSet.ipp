...
#include <sage/segreg/PedigreeDataSet.h>
#endif
...
inline
  PedigreeDataSet::SubpedigreeIterator::SubpedigreeIterator() 
    : iterator_adaptor_(SubpedigreeList::const_iterator())
{ }
...
inline
  ...
  : iterator_adaptor_(MemberList::const_iterator())
{ }
...
///
inline
std::shared_ptr<const FPED::Multipedigree>
