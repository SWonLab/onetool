...
#include "sage/segreg/binary_penetrance_calculator.h"
...
class FraBase
{
  ...
  //@}
    ...
    typedef std::function <double (FraResidType)>      ResidFuncType;
    typedef std::function <bool   (const MemberType&)> AffFuncType;
    typedef std::function <double (const MemberType&,
...
#include "sage/segreg/fam_resid_adj.ipp"
