...
#include "sage/segreg/peeling_caches.h"
...
struct ResidualGetter
{
  public:
    ...
    double operator() (FraResidType tp)
...
*/
  ...
  private:
    ...
    std::function<double (const genotype_index&)>  my_freq_function;
    std::function<double (const genotype_index&,
...
#include "sage/segreg/mlm_peeler.ipp"
