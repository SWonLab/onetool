...
#include "sage/segreg/sub_models/prev_sub_model.h"
...
class model
{
  public:
    ...
    void         set_file_name_root(const std::string& f_name)
                 { file_name_root = f_name; }
    ...
    void         set_model_class(model_class mc)
                 { m_class = mc; }
    void         set_mean_missing(bool m)
                 { mean_missing = m; }
    void         set_susc_missing(bool m)
                 { susc_missing = m; }
    void         set_type_prob(bool m)
                 { type_prob = m; }
