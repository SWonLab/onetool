...
#include "sage/segreg/sub_models/resid_sub_model.h"
...
class ascertainment_sub_model
{
  public:
    ...
    bool  set(s_sm_option so, v_sm_option vo,
              const MultiPedigree* mp, const string& pi, const std::vector<double>& includes, 
  ...
  private:
    ...
    // Set functions.
    bool  set_none(v_sm_option vo, const MultiPedigree* mp, const string& pi, const std::vector<double>&, 
                   const string& ti, double thresh, double thresh_high, double thresh_low, double it);
    bool  set_founders(v_sm_option vo, const MultiPedigree* mp, const string& pi, const std::vector<double>&, 
                       const string& ti, double thresh, double thresh_high, double thresh_low, double it);
    bool  set_psf(v_sm_option vo, const MultiPedigree* mp, const string& pi, const std::vector<double>&, 
                  const string& ti, double thresh, double thresh_high, double thresh_low, double it);
    bool  set_founders_plus_psf(v_sm_option vo, const MultiPedigree* mp, const string& pi, const std::vector<double>&, 
          const string& ti, double thresh, double thresh_high, double thresh_low, double it);
    
    // Ancillary functions.
    bool  set_actual(const MultiPedigree* mp, const string& ti, 
                     double thresh, double thresh_high, double thresh_low, double low);
    bool  set_gte_thresh(const MultiPedigree* mp, const string& ti, 
                         double thresh, double thresh_high, double thresh_low, double it);
    bool  set_lte_thresh(const MultiPedigree* mp, const string& ti, 
                         double thresh, double thresh_high, double thresh_low, double it);
    bool  set_thresh_indic(const MultiPedigree* mp, const string& ti, 
                           double thresh, double thresh_high, double thresh_low, double it);
    ...
    bool  trait_valid(const string& trait_name, RPED::RefTraitInfo::trait_t req_type1, 
                      RPED::RefTraitInfo::trait_t req_type2, const MultiPedigree* mp);
...
#include "sage/segreg/sub_models/ascertainment_sub_model.ipp"
