...
#include "sage/segreg/sub_models/fpmm_sub_model.h"
...
class onset_sub_model
{
  public:
    ...
    // Sets.
    bool  set(type_option t_option, multi_option m_option, const RefMultiPedigree* mp,  
  ...
  protected:
    ...
    bool  trait_valid(const string& trait_name, 
                      RPED::RefTraitInfo::trait_t req_type,
...
#include "sage/segreg/sub_models/onset_sub_model.ipp"
