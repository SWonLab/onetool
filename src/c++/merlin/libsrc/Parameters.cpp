...
#include "merlin/libsrc/Parameters.h"
...
void LongParameters::Status()
   ...
   int line_len = 0, line_start = group_len ? group_len + 5 : 0;
...
void ParameterList::Add(MERLIN::Parameter * p)
   {
   if (count + 1 >= size)
