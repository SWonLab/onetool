...
#include "merlin/regress/RegressParameters.h"
#include "merlin/regress/RegressAnalysis.h"
#include "merlin/merlin/MerlinCache.h"
#include "merlin/libsrc/Pedigree.h"
#include "merlin/merlin/Houdini.h"
#include "merlin/regress/AutoFit.h"
...
RegressionParameters::RegressionParameters() :
   ...
   Add(new MERLIN::StringParameter('t', "Trait Models File", RegressionAnalysis::modelsFile));
   ...
   Add(new MERLIN::LongParameters("Regression Analysis Options", longParameters));

   // The -b switch is obsolete and is thus hidden (use --bits instead)
   Add(new MERLIN::HiddenInteger('b', "Maximum Bits", MerlinCore::maxBits));
   // The -i switch is obsolete and is thus hidden (use --steps instead)
   Add(new MERLIN::HiddenInteger('i', "Steps Per Interval", MerlinCore::steps_per_interval));
   }
