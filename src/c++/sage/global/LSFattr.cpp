...
#include "sage/global/LSFnameMgr.h"
...
const void *AttrVal::Ptr() const 
{
  switch( attr_type )
  {
    case Attr_Integer: return (void *)((intptr_t)attr_val.i);
    case Attr_Real:    return (void *)((intptr_t)attr_val.f);
    case Attr_String:  return (void *)((intptr_t)attr_val.s->c_str());
