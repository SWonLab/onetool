...
#include "sage/lodlink/lodlink.h"
...
//       : INFOQC::app_base("LODLINK", argc, argv)
{
  //LSFInit();
}
...
int lodlink::main()
{
  ...
  instructions default_inst(my_data.errors());

  ofstream  summary_file; 
  string    summary_file_name = "lodpal.sum"; 
  ...
  string    detail_file_name = "lodpal.det"; 
  ...
  analysis  my_analysis(my_data.errors(), *my_mped, default_inst);
  my_analysis.build();
  my_analysis.analyze();
