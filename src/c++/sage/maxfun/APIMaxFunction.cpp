#include "sage/maxfun/APIMaxFunction.h"
...
// CONSTRUCTOR
//======================================================================
APIMaxFunction::APIMaxFunction(MaxFunction& func, ParameterMgr& info, const DebugCfg& debug)
              :
...
{ 
     //if( (my_debug_cfg.getType() == DebugCfg::COMPLETE) && (my_debug_cfg.iter_end) )
     //  { 
