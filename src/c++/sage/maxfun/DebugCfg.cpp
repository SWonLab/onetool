#include "sage/maxfun/DebugCfg.h"
...
{
  my_ostream_ptr    = NULL;
  my_ofstream_shptr = std::shared_ptr<ofstream>();
...
{
  my_ofstream_shptr = std::shared_ptr<ofstream>(new ofstream(ofilename.c_str(), append ? (ios::out | ios::app) : ios::out));
