...
Maxfun_Data::Maxfun_Data()
{
  ...
  maxf1_.thl.resize  (param_NP, NEGATIVE_INF);
  maxf1_.thu.resize  (param_NP, POSITIVE_INF); 
  ...
  theta.resize(NP(), SAGE::QNAN);
  score_vec.resize(param_NPV, SAGE::QNAN);
  score_vec2.resize(param_NPV2, SAGE::QNAN);
  score_stepsize.resize(param_NPV, SAGE::QNAN);
