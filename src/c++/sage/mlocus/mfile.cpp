...
bool InheritanceModelFile::input
  (inheritance_model_map& m, const string& fname, ostream& o)
{
  return input(m, fname, '/', "", o);
}

bool InheritanceModelFile::input
  (inheritance_model_map& m, const string& fname,
   char a_delim, string a_miss, ostream& messages)
{
  //lint --e{534}
  ...
  if(infile.peek() == '#')
  {
    ...
    string first_line = getStringSAGE(infile, "\n\r", "");
    ...
    //LSFBase* my_models = loadLSFfile(fname, "MarkerModels", cout, false);
    ...
    LSFInheritanceModelParser mparse(a_delim, errors);
  ...
  char separator = a_delim;
  string mv  = getStringSAGE( infile, "=\n\r", "");
  string mv2 = "";
  ...
  while ( !infile.eof() )
  {
    string name = strip_ws(getStringSAGE( infile, "\n\r", "" ));
...
void InheritanceModelFile::get_alleles(istream& infile, genotype_model& gm)
{
...
void InheritanceModelFile::get_phenotypes(istream& infile, penetrance_model& pm)
{
  //lint --e{534}
  ...
  do
  {
    ...
    do
    {
      ...
      string genotype = getStringSAGE( infile, "=}>", ",");
...
//=============================
// LSFInheritanceModelParser
//=============================

LSFInheritanceModelParser::LSFInheritanceModelParser(char sep, const cerrorstream& c)
