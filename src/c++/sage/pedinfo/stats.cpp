...
Cont_trait_stats::print() const
{
  ...
  cout << setw(20) << left << "All";
  cout << setw(10) << right << ind_founder_count(TOTAL);
  cout << setw(10) << right << ind_founder_mean(TOTAL);
  cout << " +/- ";
  cout << setw(10) << right << ind_founder_std_dev(TOTAL);
  cout << setw(10) << right << ind_founder_min(TOTAL);
  cout << setw(10) << right << ind_founder_max(TOTAL);
  cout << endl;
