...
#include "sage/segreg/sub_models/ascertainment_sub_model.h"
...
ascertainment_sub_model::set(s_sm_option so, v_sm_option vo,
                             const MultiPedigree* mp, const string& pi, const vector<double>& incl, 
...
//
bool  
ascertainment_sub_model::set_none(v_sm_option vo, const MultiPedigree* , 
...
bool  
ascertainment_sub_model::set_founders(v_sm_option vo, const MultiPedigree* mp, 
                                      const string& pi, const vector<double>& incl, const string& ti, 
                                      double thrsh, double thrsh_high, 
                                      double thrsh_low, double it)
{
...
bool  
ascertainment_sub_model::set_psf(v_sm_option vo, const MultiPedigree* mp, 
                                 const string& pi, const vector<double>& incl, const string& ti, 
                                 double thrsh, double thrsh_high, 
                                 double thrsh_low, double it)
{
...
bool  
ascertainment_sub_model::set_founders_plus_psf(v_sm_option vo, const MultiPedigree* mp, 
...
//
bool  
ascertainment_sub_model::set_actual(const MultiPedigree* , const string& ti, 
                                    double thrsh, double thrsh_high, 
                                    double thrsh_low, double it)
{
  my_v_option = actual;
...
bool  
ascertainment_sub_model::set_gte_thresh(const MultiPedigree* , const string& ti, 
                                        double thrsh, double thrsh_high, 
                                        double thrsh_low, double it)
{
...
bool  
ascertainment_sub_model::set_lte_thresh(const MultiPedigree* , const string& ti, 
                                        double thrsh, double thrsh_high, 
                                        double thrsh_low, double it)
{
...
bool  
ascertainment_sub_model::set_thresh_indic(const MultiPedigree* mp, const string& ti, 
                                          double thrsh, double thrsh_high, 
                                          double thrsh_low, double it)
{
...
bool 
ascertainment_sub_model::trait_valid(const string& trait_name,
                                     RPED::RefTraitInfo::trait_t req_type1,
                                     RPED::RefTraitInfo::trait_t req_type2,
                                     const MultiPedigree* mp)
{
  bool  return_value = false;
