...
static int trex_charnode(TRex *exp, bool isclass)
{
	TRexChar t;
	if(*exp->_p == TREX_SYMBOL_ESCAPE_CHAR) {
		exp->_p++;
...
static bool trex_matchcclass(int cclass,TRexChar c)
{
	switch(cclass) {
...
static bool trex_matchclass(TRex* exp,TRexNode *node,TRexChar c)
{
	do {
		switch(node->type) {
		case OP_RANGE:
...
bool trex_match(TRex* exp,const TRexChar* text)
{
...
bool trex_searchrange(TRex* exp,const TRexChar* text_begin,const TRexChar* text_end,const TRexChar** out_begin, const TRexChar** out_end)
{
...
bool trex_search(TRex* exp,const TRexChar* text, const TRexChar** out_begin, const TRexChar** out_end)
{
...
bool trex_getsubexp(TRex* exp, int n, TRexMatch *subexp)
{
