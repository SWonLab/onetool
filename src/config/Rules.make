...
#
#  Notes:   Rules for global make system
#
...
include ${ONETOOLROOT}/config/Platform.make
...
clean_source: $(CLEAN_TASKS)
	-@$(RM) $(RMFLAGS) $(TARGETS) $(TEST_TARGETS) $(TESTTARGETS) *.a *.bak *.exe *~ 2> /dev/null

clean_target:
	-@$(RM) $(RMFLAGS) $(BUILDDIR)/*$(OBJ) $(BUILDDIR)/*$(LIB)  $(BUILDDIR)/*.d 2> /dev/null
